# GenAI Guideline and Documentation

In this page, we will list the guilines of GenAI usage and examples of citations for EOSC-511. If we decide to use GenAI, the documentation of prompts, feedbacks and citations will also be attached.

## GenAI Policies for EOSC-511

**GenAI policies for EOSC-511**: https://ubc-moad.github.io/numeric_2026/gradsyllabus.html
